...
def main():
    ...
    legend = [
        ...
        ("Owning Team", "Doc Repository Permissions #1: 'Repository must have a responsible team with the Maintain role.' Whether business-solutions holds Maintain (a Maintain-level grant found elsewhere as e.g. Admin is called out in Compliance Gaps, not hidden here)."),

#!/usr/bin/env python3
"""Data-export + override-friction smoke tests for snowflake_plugin.
...
Run:
    HOMUNCULUS_NAME=<name> .venv/bin/python3 \
        plugins/snowflake_plugin/tests/smoke_data_export.py
...
def main() -> int:
    print("\nsnowflake_plugin data-export/override smoke tests")
    print("=" * 52)
